...
const WhatsAppWindow = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={ showWindow ? 'd-flex flex-column justify-content-centr wpp-window bg-mark border border-dark p-2 rounded-3' : 'd-none'}
        style={{ width: '250px' }}
      >
        <div className='d-flex align-items-center'>
          <p className='text-center m-0 font-weight-bold flex flex-grow-1 h5'>Fale com o Mateus!</p>
          <i
            className='fa fa-window-close text-danger'
            onClick={() => switchWindow()}
          />
        </div>
        <div className='img-container p-2 w-100'>
          <img
