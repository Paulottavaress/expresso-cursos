...
const TransporteColetivoSellingPage = () => {
  ...
  useEffect(() => {
    if (availableCourses.length > 0) {
      setCourseInfo(availableCourses.filter((course) => (course.id.slice(0, 8) === process.env.REACT_APP_TRANSPORTE_COLETIVO_BASE_ID) && (location.pathname.includes(course.type))));
    }
  }, [availableCourses]);
